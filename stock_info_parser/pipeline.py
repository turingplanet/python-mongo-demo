import yaml
import pandas as pd
from stock_info_parser.nasdaq_fetcher import NasdaqDataFetcher
...
class StockDataCollector:
    ...
    nasdaq_company_list_file = './tmp/nasdaq_100.csv'
    COMPANY_OVERVIEW_FILE = './tmp/company_overview.csv'
    STOCK_WEEKLY_DATA_FILE = './tmp/stock_weekly_data.csv'
    QUARTERLY_EARNINGS_FILE = './tmp/quarterly_earnings.csv'
    CASH_FLOW_FILE = './tmp/cash_flow.csv'
    NEWS_SENTIMENT_FILE = './tmp/news_sentiment.csv'
